...
<li>In order to "Clone" the sample App, touch the QR-code icon and point the camera to the code below.
<ul>
...
<p style="text-align: center;">&nbsp;<img src="/pics/Blynk Dashboard.jpg" alt="" width="188"/>&nbsp;<img src="/pics/Blynk Clone.jpg" alt="" width="188"/></p>
